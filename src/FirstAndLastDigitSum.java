...
//    }
    ...
    public static void main(String[] args) {
        FirstAndLastDigitSum flds = new FirstAndLastDigitSum();
        System.out.println(flds.sumFirstAndLastDigit(257)); //2 + 7 = 9
        System.out.println("----------------------------");

        System.out.println(flds.getEvenDigitSum(252));  //2 + 2 = 4
        System.out.println(flds.getEvenDigitSum(2000));  //2
    }
}
